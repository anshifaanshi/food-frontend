...
function Aboutus() {
  ...
  // Simulate image loading (or use actual async calls here)
  useEffect(() => {
      ...
      <section className="my-10 bg-gray-100 py-10 px-8 md:px-20 lg:px-32">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          ...
          <div className="bg-white shadow-md rounded-lg p-4 w-60">
            <img src="https://via.placeholder.com/150" alt="Team Member" className="w-full h-40 object-cover rounded-md mb-4" />
